  ...
  return (
    <div className={s.container}>
      <div className={s.wrapper}>
        <button type="button" className={s.button} onClick={openModal} disabled={isModalOpen}>
          <SvgIcon name="icon-filter" width="16" height="16" className={s.icon} />
          <p className={s.title}>Filters</p>
        </button>
      </div>
      {isModalOpen && (<div ref={modalRef} className={`${s.filtersModal} ${modalStyle ? s.exiting : ''}`} onClick={(e) => e.stopPropagation()}  >
